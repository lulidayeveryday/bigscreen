...
export default class WordCloud extends React.Component{
    ...
    wordCloud(){
        ...
        maskImage.src = '/src/js/component/Common/Test/555.png';
        ...
        var maskImage = new Image();
        maskImage.src = '/src/js/component/Common/Test/111.png';
        var option = {
        ...
        var pieChart = echarts.init(this.refs.wordCloud);
    ...
    render(){
        return(
            <div>
                <div ref="wordCloud" id="wordCloud-div"></div>
                <div className="wordCloud-background"></div>
            </div>
        )
    }
}